...
The model was evaluated on the 25% test set and produced the following results:
...
> The model correctly identifies cancer cases with a recall of 0.90, meaning it misses very few actual positive cases — which is critical in a medical screening context.
...
Assignment/
│
├── generate_dataset.py       # Generates the lung cancer survey dataset
...
- UCI ML Repository: https://archive.ics.uci.edu/ml/datasets/lung+cancer
